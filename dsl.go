...
// so the import stays in a single place and a call site stays short.
//
// A single shape differs from a plain rename: the element name is the
// method Name(), never a field.
