...
docker run --rm -p 127.0.0.1:8080:8080 -e GH_TOKEN=ghp_xxx ghcr.io/wow-look-at-my/github http://0.0.0.0:8080

# SSE on port 8080
docker run --rm -p 127.0.0.1:8080:8080 -e GH_TOKEN=ghp_xxx ghcr.io/wow-look-at-my/github sse://0.0.0.0:8080
```
